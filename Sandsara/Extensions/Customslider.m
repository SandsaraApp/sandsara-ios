...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.toolTipValue) {
        ...
        CGSize s = [_toolTipValue sizeWithAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIColor whiteColor], NSForegroundColorAttributeName,[UIFont fontWithName:@"OpenSans-Regular" size:12], NSFontAttributeName, nil]];
        ...
        [_toolTipValue drawInRect:textRect withAttributes:[NSDictionary dictionaryWithObjectsAndKeys:[UIFont fontWithName:@"OpenSans-Regular" size:12], NSFontAttributeName,theStyle, NSParagraphStyleAttributeName, nil]];
    }
}
